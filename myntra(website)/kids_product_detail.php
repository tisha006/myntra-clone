            ...
            <div class="col-md-6">
                ...
                <div class="product-details">
                    ...
                    <form id="addToCartForm_<?php echo $product_id; ?>" action="add_to_cart.php" method="post">
                        ...
                        <button type="button" onclick="addToCartMessage('<?php echo $row['description']; ?>', '<?php echo $row['image']; ?>', <?php echo $product_id; ?>)" class="purchase-btn">Move to Bag</button>
                </form>
                <a href="address.php?type=kids&<?= http_build_query(['name' => urlencode($row['description']), 'price' => urlencode($row['price']), 'image' => urlencode($row['image'])]); ?>"class="purchase-btn" style="margin-left:30%;margin-top:-15px;text-decoration:none;color:white;">Buy Now</a>

    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                ...
                ?>
               <hr> <img src="<?php echo $row['p_image']; ?>" alt="Product Image" class="product-image"><hr>
            ...
            <div class="col-md-6">
                ...
                <div class="product-details">
                    ...
                    <h2><?php echo isset($row['p_name']) ? $row['p_name'] : 'Product Name Not Available'; ?></h2><br>
                    <!-- <p style="margin-bottom:20px">Category: <?php //echo isset($row['category']) ? $row['category'] : 'Category Not Available'; ?></p> -->
                    <p style="margin-bottom:25px">Price: ₹<?php echo isset($row['price']) ? $row['price'] : 'Price Not Available'; ?></p>
                    
                    <!-- Add a form to handle purchase -->
                    <form id="addToCartForm_<?php echo $product_id; ?>" action="add_to_cart.php" method="post">
                        ...
                        <button type="button" onclick="addToCartMessage('<?php echo $row['p_name']; ?>', '<?php echo $row['p_image']; ?>', <?php echo $product_id; ?>)" class="purchase-btn">Move to Bag</button>
                    </form>
                    <a href="address.php?type=men&<?= http_build_query(['name' => urlencode($row['p_name']), 'price' => urlencode($row['price']), 'image' => urlencode($row['p_image'])]); ?>" class="purchase-btn" style="margin-left:30%;margin-top:-15px;color:white;text-decoration:none;">Buy Now</a>

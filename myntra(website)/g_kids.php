  ...
  if ($result->num_rows > 0) {
      ...
      while($row = $result->fetch_assoc()) {
          ...
          <div class='col-xl-4 col-md-4 col-sm-6 mt-5'>
                  ...
                  <a href="productdetail.php?product_id=<?php echo $row['id']; ?>" class="an">
                  <?php
                  echo '<img class="card-img-top" src="' . $row['image'] . '" alt="' . $row['description'] . '" width="80%" height="450px">';

                  ?>
                  <form action="wishlist.php" method="post">
    <input type="hidden" name="add_to_wishlist" value="1">
    <input type="hidden" name="product_id" value="<?php echo $row['id']; ?>">
    <input type="hidden" name="product_type" value="kids">
    <button type="submit" style="width:1px;height:1px;right:16px;" class="wishlist-icon">
    <img src="images/wishlistlogo.png" style="right:-5px;top:-10px;" class="wishlist-icon" alt="Add to Wishlist">
                  ...
                  <div class='antima'>
                                    ...
                                    if ($Price > 0) {
                                    ?>
                  <a href="kids_product_detail.php?product_id=<?php echo $row['id']; ?>" ID="cashpay">Buy now</a>
...
<!-- <div class="w">
    <div>
        <img class="w_img" src="./images/g_k1.jpg"  width="321px"height="360px">
        <h4 class="w_img_tital">Hello</h4>
        <h5  class="w_img_tital">Price</h5>
    </div>
    <div>
        <img class="w_img" src="./images/g_k2.jpg"  width="321px"height="360px">
        <h4 class="w_img_tital">Hello</h4>
        <h5  class="w_img_tital">Price</h5>
    </div>   
    <div>
        <img class="w_img" src="./images/g_k3.jpg"  width="321px"height="360px">
        <h4 class="w_img_tital">Hello</h4>
        <h5  class="w_img_tital">Price</h5>
    </div>        
</div>
...
<div class="w">
    <div>
        <img class="w_img" src="./images/g_k4.jpg"  width="321px"height="360px">
        <h4 class="w_img_tital">Hello</h4>
        <h5  class="w_img_tital">Price</h5>
    </div>
    <div>
        <img class="w_img" src="./images/g_k5.jpg"  width="321px"height="360px">
        <h4 class="w_img_tital">Hello</h4>
        <h5  class="w_img_tital">Price</h5>
    </div>   
    <div>
        <img class="w_img" src="./images/g_k.jpg"  width="321px"height="360px">
        <h4 class="w_img_tital">Hello</h4>
        <h5  class="w_img_tital">Price</h5>
    </div>        
</div>
...
<div class="w">
    <div>
        <img class="w_img" src="./images/g_k7.jpg"  width="321px"height="360px">
        <h4 class="w_img_tital">Hello</h4>
        <h5  class="w_img_tital">Price</h5>
    </div>
    <div>
        <img class="w_img" src="./images/g_k8.jpg"  width="321px"height="360px">
        <h4 class="w_img_tital">Hello</h4>
        <h5  class="w_img_tital">Price</h5>
    </div>   
    <div>
        <img class="w_img" src="./images/g_k9.jpg"  width="321px"height="360px">
        <h4 class="w_img_tital">Hello</h4>
        <h5  class="w_img_tital">Price</h5>
    </div>        
</div> -->
